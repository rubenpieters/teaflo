...
function basicCrewTest() {
  const path1: Path = {
    ...
    eventCards: [
      { actions: [{ tag: "AddCrew", crew: allCrew.recruitGrow1 }], id: 0, name: "", tag: "event", subtag: "general" },
      { actions: [{ tag: "AddCrew", crew: allCrew.stFighter }], id: 0, name: "", tag: "event", subtag: "general" },
      { actions: [{ tag: "AddCrew", crew: allCrew.stFighter }], id: 0, name: "", tag: "event", subtag: "general" },
    ]
  }
...
function basicBattleTest() {
  const path1: Path = {
    ...
    eventCards: [
      ...
      { actions: [{ tag: "BattleTurn" }], id: 0, tag: "event", name: "", subtag: "general" },
      { actions: [{ tag: "BattleTurn" }], id: 0, tag: "event", name: "", subtag: "general" },
      { actions: [{
        tag: "PayGold",
        pay: 5,
...
function basicApDamageTest() {
  const path1: Path = {
    ...
    eventCards: [
      ...
      { actions: [{ tag: "BattleTurn" }], id: 0, name: "", tag: "event", subtag: "general" },
    ]
  }
  const solution: Solution = {
    paths: [path1]
