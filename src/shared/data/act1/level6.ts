...
export const a1l6_fr1_ab1: Ability =
  A.combinedAbility([
    ...
    new A.AddThreat("Ability", "Target", new Ab.Static(15), new Ab.FromInput(0), Ab.allEnemy()),
  ]);
...
export const a1l6_fr1_ab2: Ability =
  A.combinedAbility([
    new A.UseCharge("Ability", "Target", new Ab.Static(1), Ab.self()),
    new A.RestoreCharge("Ability", "Target", new Ab.Static(2), new Ab.FromInput(0)),
    new A.Damage("Ability", "Target", new Ab.Static(13), new Ab.FromInput(0)),
  ]);
...
export const a1l6_en1: EnUnit = {
  ...
  abilities: {
    ...
    1: {
      ability: a1l6_en1_ab2,
      spriteId: "ab3",
      name: "a1l5_en1_ab2",
    },
    2: {
      ability: a1l6_en1_ab3,
      spriteId: "ab3",
      name: "a1l5_en1_ab3",
    },
    5: {
      ability: a1l6_en1_ab4,
      spriteId: "ab3",
      name: "a1l5_en1_ab4",
    },
    4: {
      ability: a1l6_en1_ab5,
      spriteId: "ab1",
      name: "a1l5_en1_ab5",
    },
  },
