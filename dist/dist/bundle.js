...
module.exports = __webpack_require__(/*! /home/rubenpieters/Projects/teaflo/dist/src/main.js */333);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_src_states_Boot__ = __webpack_require__(/*! src/states/Boot */ 338);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_src_states_Splash__ = __webpack_require__(/*! src/states/Splash */ 339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_src_states_Menu__ = __webpack_require__(/*! src/states/Menu */ 341);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_src_states_Game__ = __webpack_require__(/*! src/states/Game */ 344);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_src_config__ = __webpack_require__(/*! src/config */ 129);
...
class Game extends __WEBPACK_IMPORTED_MODULE_2_phaser___default.a.Game {
  constructor() {
    ...
    this.state.add('Boot', __WEBPACK_IMPORTED_MODULE_3_src_states_Boot__["a" /* default */], false);
    this.state.add('Splash', __WEBPACK_IMPORTED_MODULE_4_src_states_Splash__["a" /* default */], false);
    this.state.add('Menu', __WEBPACK_IMPORTED_MODULE_5_src_states_Menu__["a" /* default */], false);
    this.state.add('Game', __WEBPACK_IMPORTED_MODULE_6_src_states_Game__["a" /* default */], false);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_src_config__ = __webpack_require__(/*! src/config */ 129);
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  ...
  preload() {
    if (__WEBPACK_IMPORTED_MODULE_2_src_config__["a" /* default */].webfonts.length) {
      __WEBPACK_IMPORTED_MODULE_1_webfontloader___default.a.load({
        google: {
          families: __WEBPACK_IMPORTED_MODULE_2_src_config__["a" /* default */].webfonts
        },
  ...
  render() {
    if (__WEBPACK_IMPORTED_MODULE_2_src_config__["a" /* default */].webfonts.length && this.fontsReady) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser__ = __webpack_require__(/*! phaser */ 42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_src_utils__ = __webpack_require__(/*! src/utils */ 340);
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  ...
  preload() {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_1_src_utils__["a" /* centerGameObjects */])([this.loaderBg, this.loaderBar]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser__ = __webpack_require__(/*! phaser */ 42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_src_sprites_Mushroom__ = __webpack_require__(/*! src/sprites/Mushroom */ 342);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_js_purs_bundle_js__ = __webpack_require__(/*! js/purs.bundle.js */ 343);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_js_purs_bundle_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_js_purs_bundle_js__);





const buttonMap = __WEBPACK_IMPORTED_MODULE_2_js_purs_bundle_js___default.a.buttonMap();
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  ...
  create() {
    ...
    this.mushroom = new __WEBPACK_IMPORTED_MODULE_1_src_sprites_Mushroom__["a" /* default */]({
      game: this.game,
      x: xCenter2,
      y: yCenter2,
      asset: 'mushroom'
...
var require;var require;(function(f){if(true){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}(g.purs || (g.purs = {})).bundle = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return require(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  ...
  create() {
    ...
    boundsPoint = new __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Point(0, 0);
    viewRect = new __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Rectangle(0, 0, this.game.width, this.game.height);
    ...
    for (var i = 0; i < 1000; i++) {
      ...
      sqr.events.onInputDown.add(function (i) {
        return function () {
  ...
  update() {
    ...
    if (this.game.input.keyboard.isDown(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.Q)) {
      zoom += 0.05;
    }
    if (this.game.input.keyboard.isDown(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.A)) {
      zoom -= 0.05;
    }
    zoom = __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Math.clamp(zoom, 0.3, 2);

    gameWorld.scale.set(zoom);

    bgGroup.forEachExists(function (circ) {
      boundsPoint.setTo((circ.x - gameWorld.pivot.x) * gameWorld.scale.x + game.width * 0.5, (circ.y - gameWorld.pivot.y) * gameWorld.scale.y + game.height * 0.5);
      if (__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Rectangle.containsPoint(viewRect, boundsPoint)) {
        circ.visible = true;
      } else {}
    });
  }
  ...
  hold(x) {
    ...
    gameWorld.pivot.x = __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Math.clamp(this.oldCamX - diffX * (0.5 / zoom), -gameX, gameX);
    gameWorld.pivot.y = __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Math.clamp(this.oldCamY - diffY * (0.5 / zoom), -gameY, gameY);
  }
});
