...
export const a1l5_fr2_ab2: Ability =
  A.combinedAbility([
 ...
 * En Unit
 */
const a1l5_status: S.OnDeath = new S.OnDeath(
  new A.RestoreCharge("ST", "SATarget", new C.Static(1), Ab.allEnemyExceptSelf()),
  1,
);

export const a1l5_en1_ab1: Ability =
  A.combinedAbility([
    new A.AddStatus("Ability", "Target", new Ab.Static(a1l5_status), Ab.self()),
    new A.MoveAI("Ability", "Target", new Ab.Static("right" as AIDirection), Ab.self()),
  ]);

export const a1l5_en1_ab2: Ability =
  new A.Damage("Ability", "Target", new Ab.Static(1), Ab.highestThreat())
  ;
