...
let levelSelectGroup: Phaser.Group;

export default class Game extends Phaser.State {
  public init(): void {
    actSelectBtnPool = new Phaser.Group(this.game);
    levelSelectBtnPool = new Phaser.Group(this.game);
    levelSelectGroup = new Phaser.Group(this.game);
  }

  public create(): void {
    this.stage.backgroundColor = 0xDCDCDC;

    actSelect_Main(this.game, actSelectBtnPool, levelSelectBtnPool, levelSelectGroup);
  }
