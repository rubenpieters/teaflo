 ...
 * En Unit
 */
export const a3l3_en1_2_ab1: Ability =
  A.combinedAbility([
    new A.Damage("Ability", "Target", new Ab.Static(2), Ab.highestThreat()),
  ]);

export const a3l3_en1_2: EnUnit = {
  hp: 20,
  maxHp: 20,
  charges: 5,
  maxCharges: 5,
...
export const a3l3_en2_2_ab1: Ability =
  A.combinedAbility([
    new A.Damage("Ability", "Target", new Ab.Static(2), Ab.highestThreat()),
  ]);

export const a3l3_en2_2: EnUnit = {
  hp: 20,
  maxHp: 20,
  charges: 5,
  maxCharges: 5,
